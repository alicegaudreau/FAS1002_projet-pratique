...
Ce rapport utilise les données de @gapminderlifeexpectancyatbirth et de @owidenergy afin d'étudier l'évolution de la consommation d'énergie dans le monde.

[Gapminder](https://www.gapminder.org/) est un organisme à but non lucratif indépendant qui offre ses données en libre accès afin de lutter contre la désinformation.

Quant à [Our World With Data](https://ourworldindata.org/), il s'agit d'une organisation affiliée à l'Université d'Oxford qui offre également ses données en libre accès afin de contribuer à des enjeux de société mondiaux.
...
### I. Consommation d'énergie et population
...
### II. Type d'énergie utilisée pour l'électricité consommée au fil du temps
