...
f \<- system.file(package = "cronR", "extdata", "desespoir1000.R")
...
#Statique : J'ai téléchargé les données par pays directement à partir du Google Drive et ajouté le csv au projet. 
...
# f   <- system.file(package = "cronR", "extdata", "desespoir1000.R")
# path <- file.path("desespoir1000.R")
# cmd <- cron_rscript(f)
# cmd
# cron_add(command = cmd, frequency = 'minutely', id = 'test1', description = 'My process 1')
